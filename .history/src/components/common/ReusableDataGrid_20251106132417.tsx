...
export const ReusableDataGrid: React.FC<ReusableDataGridProps> = ({
  ...
  const renderItem = ({ item }: { item: any }) => {
    ...
    return (
      <Card 
        style={[styles.card, { backgroundColor: theme.colors.surface || '#ffffffff' }]} // Dark Card background
        elevation={4}
      ...
      >
        ...
        <Divider style={{ marginHorizontal: 16, backgroundColor: theme.colors.outlineVariant || 'rgba(208, 208, 208, 0.2)' }} />
    ...
    <SafeAreaView style={[styles.container, { backgroundColor: theme.colors.background || '#000000' }]}>
        ...
        <View style={styles.searchContainer}>
          <Searchbar
            ...
            inputStyle={{ 
                color: theme.colors.onSurface || 'dark', // Input text color
                minHeight: 0 
            }}
            style={[styles.searchbar, { backgroundColor: theme.colors.surface || '#ff2222ff' }]}
          />
        </View>
...
const styles = StyleSheet.create({
  ...
  emptyContainer: { 
    ...
    borderRadius: 12,
    borderWidth: 1,
    borderColor: 'rgba(255, 230, 230, 0.1)', // Light border for dark theme
  },
  pagination: { 
    flexDirection: 'row', 
    justifyContent: 'space-between',
