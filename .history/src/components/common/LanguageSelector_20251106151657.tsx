...
import { View, StyleSheet, Platform, StatusBar, Modal, ScrollView } from 'react-native';
import { IconButton, Dialog, Portal, Button, Text, List } from 'react-native-paper';
        ...
        >
          <View style={styles.androidModalOverlay}>
            <View style={styles.androidModalContent}>
              <Text style={{ marginBottom: 8, fontWeight: '700' }}>Change language</Text>
              <ScrollView>
                {languages.map((lang) => (
                  <List.Item
                    key={lang.code}
              ...
              <Button onPress={() => setVisible(false)} style={{ marginTop: 8 }}>
                Close
              </Button>
            </View>
          </View>
