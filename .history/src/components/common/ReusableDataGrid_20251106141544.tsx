...
export const ReusableDataGrid: React.FC<ReusableDataGridProps> = ({
  ...
  useEffect(() => {
    ...
    fetchData();
  }, [fetchData]); //dont call here fetchData that causes infinite loop
    ...
    <SafeAreaView style={[styles.container, { backgroundColor: "#ffffff" }]}>
      ...
      <View
        style={[
          ...
          { backgroundColor: "#ffffff", borderBottomColor: "#e6e6e6" },
        ]}
      >
        <Text variant="headlineMedium" style={{ color: "#111111" }}>
          {title}
        </Text>
        <IconButton
          icon="reload"
