...
export const ReusableDataGrid: React.FC<ReusableDataGridProps> = ({
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      // Many backends expect 1-based page indexing. Send page as 1-based while keeping
      // paginationModel.page zero-based for client-side slicing.
      const basePayload = {
              ...
              ? () => (
                  ...
                  >
                    ...
                    <Button
                      disabled={isLastPage}
                      onPress={() =>
                        setPaginationModel((p) => ({ ...p, page: p.page + 1 }), fetchData())
                      }
                      icon="chevron-right"
                      mode="text"
                      compact
