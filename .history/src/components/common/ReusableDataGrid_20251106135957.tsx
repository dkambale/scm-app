...
export const ReusableDataGrid: React.FC<ReusableDataGridProps> = ({
  ...
  const renderItem = ({ item }: { item: any }) => {
    ...
    return (
      <Card style={[styles.card, { backgroundColor: theme.colors. }]} elevation={4}>
        <Card.Content>
          <View style={styles.cardHeaderRow}>
            <View style={{ flex: 1 }}>
              ...
              <View style={styles.metaRow}>
                ...
                <Text style={{ marginLeft: 8, color: '#6b6b6b' }}>{item.visibility || ''}</Text>
              </View>
            </View>
          ...
          {columns.slice(1, 4).map((col) => (
            <View key={col.key} style={styles.dataRow}>
              <Text variant="labelSmall" style={{ color: '#6b6b6b' }}>{col.header}</Text>
