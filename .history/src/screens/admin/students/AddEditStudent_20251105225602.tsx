...
import { ReusableForm, IFormField as FormField } from "../../../components/common/ReusableForm";import * as Yup from 'yup';
...
export const AddEditStudent: React.FC = () => {
  ...
  return (
    <ReusableForm
      ...
      cancelAction={() => navigation.navigate('StudentList' as never)}
      tNamespace="student"
    />
  );
};
