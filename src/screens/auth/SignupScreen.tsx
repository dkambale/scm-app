...
export const SignupScreen: React.FC = () => {
  ...
  const handleSignup = async (values: SignupValues) => {
    ...
    try {
      ...
      const type = response.user?.type?.toUpperCase() as 'ADMIN' | 'TEACHER' | 'STUDENT'; 

      if (!accountId || !type) {
        throw new Error("Registration succeeded but response is missing account or user type for auto-login.");
      }
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        <View style={styles.content}>
          ...
          <Card style={styles.card}>
            <Card.Content>
              <Formik
                initialValues={{ userName: '', password: '', firstName: '', lastName: '', address: '' }}
